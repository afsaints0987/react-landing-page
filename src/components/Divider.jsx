    ...
    return (
        <section id="solutions" className="bg-white text-dark mh-100 py-3">
            <div className="container">
                <div className="row">
                    <div className="col-md-6 d-flex flex-column align-self-center text-custom">
                ...
                <div className="row d-flex flex-row-reverse justify-content-lg-between mb-5 text-custom">

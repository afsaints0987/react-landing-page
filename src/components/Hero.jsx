    ...
    return (
        <div className="banner vh-100 bg-transparent">
            <div className="container d-sm-flex text-light align-items-center text-center text-sm-start pt-5">
                <div className="col">
                    <h1 className="align-self-center my-4 mw-100">Generate Leads With <span className="text-success">Attractive Websites.</span></h1>
                    ...
                    <button className="btn btn-success mt-5 px-4">Get Your Free Proposal &#8594;</button>
                </div>

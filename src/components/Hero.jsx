        ...
        <div className="banner vh-100 bg-transparent">
            <div className="container d-sm-flex text-light align-items-center text-center text-sm-start pt-5">
                <div className="col">
                    ...
                    <p className="header-text">A modern, responsive Website is the best marketing strategy that a company can put in place. Good thing that we can Help you with that!</p>
